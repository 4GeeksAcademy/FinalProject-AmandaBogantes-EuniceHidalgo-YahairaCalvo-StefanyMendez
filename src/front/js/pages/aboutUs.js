            ...
            <div className='container '>
                <div className='row  '>
                    <div className='about-1 ms-auto mt-5'>
                        ...
                        <p>In the year 2023, four visionary women, experts in different areas of technology, joined forces to found EYA Solutions, a company that has become a beacon of innovation in the world of web development and asset management.
                        ...
                        <div className='row'>
                            ...
                            <div className='col-md-6'>
                                <div className='about-item text-center'>
                                    ...
                                    <hr />
                                    <p>At EYA Solutions, our mission is to simplify and enhance the equipment maintenance process through advanced technological solutions. We aim to provide companies of all sizes with an intuitive and efficient web platform that optimizes asset management, reducing costs and maximizing productivity.</p>
                                </div>
                            </div>
                            ...
                            <div className='col-md-6'>
                                <div className='about-item text-center'>
                                    ...
                                    <hr />
                                    <p>Our vision at EYA Solutions is to lead the way towards a future where equipment maintenance is synonymous with efficiency and operational excellence. We envision a world where every company, regardless of their industry, leverages our platform to ensure the longevity and optimal performance of their assets.
